# CLAUDE.md - Guía de Desarrollo para Claude en Para_Ace

Este archivo define comandos de compilación/test e instrucciones de estilo para el proyecto Para_Ace.
